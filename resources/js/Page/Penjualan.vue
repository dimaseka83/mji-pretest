            ...
            <v-card-text>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12">
                            <v-text-field v-model.number="formPenjualan.jumlah" @keypress="isNumber($event)" label="Jumlah Item"></v-text-field>
                        </v-col>
                    </v-row>
                </v-container>
            </v-card-text>
...
export default {
    ...
    methods: {
        ...
        inventorySelect(event) {
            this.formPenjualan.inventory_id = event;
        },
                isNumber(evt) {
        ...
        save() {
            axios.post('/api/add-penjualan', this.formPenjualan)
                .then(response => {
